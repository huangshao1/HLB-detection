...
def create_model(num_classes):
    ...
    # net.load_state_dict(torch.load('./mobilenet_v3_large.pth', map_location='cpu'))
    ...
    backbone = net.features[:9]
    # print(backbone)
    backbone.out_channels = 80
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='./data/coco_wogan41_roate', help='dataset')
    # 检测目标类别数(不包含背景)
