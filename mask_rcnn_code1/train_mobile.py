...
def create_model(num_classes):
    ...
    for name, param in model.parameters():
        param.requires_grad = False
    # last_layer_names = 'backbone[1]'
    # for name, param in model.named_parameters():
    #     if name.startswith(last_layer_names):
    #         param.requires_grad = False
    # print(model)
    return model
...
if __name__ == "__main__":
    ...
    # 训练数据集的根目录
    parser.add_argument('--data-path', default='./data/coco_qicheng', help='dataset')
    # 检测目标类别数(不包含背景)
